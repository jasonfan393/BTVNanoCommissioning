...
#                            print(merged_output[sample].keys())
...
#
                ...
                scaled[sample][key] = h
                if sample in xs_dict.keys():
                    scaled[sample][f"{key}_PDF_weightUp"] = h
                    scaled[sample][f"{key}_PDF_weightDown"] = h
                    scaled[sample][f"{key}_aS_weightUp"] = h
                    scaled[sample][f"{key}_aS_weightDown"] = h
                    scaled[sample][f"{key}_scalevar_muRUp"] = h
                    scaled[sample][f"{key}_scalevar_muRDown"] = h
                    scaled[sample][f"{key}_scalevar_muFUp"] = h
                    scaled[sample][f"{key}_scalevar_muFDown"] = h
                    scaled[sample][f"{key}_UEPS_ISRUp"] = h
                    scaled[sample][f"{key}_UEPS_ISRDown"] = h
                    scaled[sample][f"{key}_UEPS_FSRUp"] = h
                    scaled[sample][f"{key}_UEPS_FSRDown"] = h
    return scaled
